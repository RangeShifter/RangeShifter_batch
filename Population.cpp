...
int Population::resolveTransfer(Species* pSpecies, std::vector<Individual*>& dispInds, Landscape* pLandscape, short landIx)
{
	int ndispersers = 0;
	int disperser;
	Patch* pPatch = 0;
...
int Population::resolveSettlement(Species* pSpecies, std::vector<Individual*>& dispInds, Landscape* pLandscape, short nextseason)
#else
